...
Page({
    ...
    submitFn() {
        ...
        if (data.group_full_people_1&&data.group_full_price_1&&data.group_full_people_2&&data.group_full_price_2&&data.group_full_people_3&&data.group_full_price_3) {
        }else{
            wx.showToast({
                title: '请补全拼团方案',
                icon: 'none',
        ...
        if (!data.is_group_master_boon) {
            ...
            if (data.is_group_master_boon=="true") {
                if (!data.group_master_boon) {
                    wx.showToast({
                        title: '请输入团长福利',
                        icon: 'none',
                    })
